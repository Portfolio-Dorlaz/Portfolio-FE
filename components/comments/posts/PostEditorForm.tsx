...
export default function PostEditorForm({
  ...
  const updateImagePreview = (file?: File) => {
    ...
    setImageFile(file);
    setBlobPreviewUrl(nextPreviewUrl);
    return true;
  };
  ...
  const subtitleText =
    mode === "create"
      ? "Tạo nội dung mới cho portfolio, thêm hình ảnh đại diện và xuất bản trực tiếp hoặc lưu dưới dạng draft."
      : "Chỉnh sửa nội dung bài viết, cập nhật ảnh đại diện và thay đổi trạng thái xuất bản.";
